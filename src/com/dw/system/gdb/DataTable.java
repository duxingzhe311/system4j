...
//	}
	 ...
	 * @param uniquecol 数据库中唯一列值
	 * @param syncols 需要同步的列名称
	 * @param bdel 是否要做记录删除--有些情况下，由外界程序做删除，此时本同步不需要做删除，则输入参数false
	 */
