 ...
 * 
 * <b>该类没有使用Notify机制来控制线程,因为可能j2me不支持. 所以采用线程不断的询问sleep达到类似的效果</b>
 * 
 * @author Jason Zhu
 */
public class QueueThreadNoWait
{
	private long NO_WAIT_CHECK_INTERVAL = 10 ;
...
//					处理成功
	...
	public void start()
	{
		...
		procTh = new Thread(runner,"queue_thread_nowait") ;
		procTh.start() ;
	}
	...
	{
		QueueThreadNoWait qt = new QueueThreadNoWait(new TestHandler()) ;
		qt.start() ;
