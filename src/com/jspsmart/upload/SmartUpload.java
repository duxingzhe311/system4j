...
// Classes: 1   Methods: 38   Fields: 21
...
public class SmartUpload
{
        ...
        throws ServletException
    {
        ...
        m_formRequest.sorReq = request;
        m_response = response;
        if(req_enc==null||req_enc.equals(""))
        	req_enc = "UTF-8";
    }
        ...
        throws ServletException
    {
        ...
        m_formRequest.sorReq = m_request;
        m_response = (HttpServletResponse)pageContext.getResponse();
        req_enc = m_request.getCharacterEncoding() ;
        if(req_enc==null||req_enc.equals(""))
        	req_enc = "UTF-8";
    }
        ...
        throws SmartUploadException, IOException, ServletException
    {
        ...
        InputStream ins = m_request.getInputStream () ;
       
        for(; totalRead < m_totalBytes; totalRead += readBytes)
        {
            try
            {
                readBytes = ins.read(m_binArray, totalRead, m_totalBytes - totalRead);
            }
            catch(Exception e)
            {
            	e.printStackTrace () ;
        ...
        do
        {
            ...
            {
            	// String value1 = new String(m_binArray, m_startData, (m_endData - m_startData) + 1) ;
            	String value = null ;
            	try
            	{
               	   value = new String(m_binArray, m_startData, (m_endData - m_startData) + 1 , req_enc);
                // log.log ("value = " + value + " value1 = " + value1) ;
                }
                catch (Throwable _t)
                {
                	// ignore ArrayIndexOutOfBoundException
                	value = new String () ;
                }
    ...
    private void getDataSection()
    {
        ...
        if (m_endData == 0)
        {
        	System.out.println ("m_endData:" + m_endData + 
	        	...
	        	",boundaryLen:" + boundaryLen) ;
        	m_endData = m_currentIndex - 1 ;
        	m_currentIndex = m_totalBytes - 2 ;
    ...
    private String getDataHeader()
    {
		...
		try
		{
        	return new String(m_binArray, start, (end - start) + 1 , req_enc);
        }
        catch (Throwable _t)
        {
        	// ignore 
