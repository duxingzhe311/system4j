...
public class WBMailBodyDisplay
{
  ...
  public static WBMailBodyDisplay createDisplayBody(Message msg)
    throws Exception
  {
    WBMailBodyDisplay rets = new WBMailBodyDisplay(msg);
  ...
  public WBMailBodyDisplay(Message msg)
  {
    this.mailMsg = msg;
  }
