...
public class DownloadDocFile extends DocCmder
{
  public DownloadDocFile(AbstractDocManager adm)
  {
    super(adm);
  }
    ...
    throws Exception
  {
    ...
    String fn = di.getDocFileName() + "." + adfi.getFileExt();
