...
public class BizViewCellRuntime
{
  ...
  public BizViewCellRuntime(IRuntimeCompilerEnv env)
  {
    this.compEnv = env;
  }

  public BizViewCellRuntime(OutputStream output)
  {
    String tmps = System.getProperties().getProperty("wf.debug").trim();
    if ("ignore".equals(tmps))
      isDebug = 0;
  ...
  public BizViewCellRuntime(JspAppCompiler jac, OutputStream output)
  {
    String tmps = System.getProperties().getProperty("wf.debug").trim();
    if ("ignore".equals(tmps))
      isDebug = 0;
  ...
  private String compile() throws IOException, Exception
  {
    ...
    BizViewCellCompiler jspc = new BizViewCellCompiler(this.compEnv.getJspAppReader(), 
