...
public class BizViewCellCompiler
{
  ...
  private void init()
  {
    ...
    this.importSB.append(lineSep);
    this.importSB.append("import com.dw.mltag.*;");
    ...
    this.functionSB.append(tabSpace(TAB_FUNC) + "protected void renderCell(Writer _jsp_output_jac)");
  ...
  public BizViewCellCompiler(String source, String ext_classname)
    throws IOException
  {
  ...
  public BizViewCellCompiler(String source, String target, String ext_classname)
    throws IOException
  {
    int i = source.lastIndexOf(".jsp");
    if (i < 0)
  ...
  public BizViewCellCompiler(JspAppReader jar, String classname, String target, String ext_classname)
    throws IOException
  {
    if (target.endsWith(".java"))
      setOutputFile(target);
